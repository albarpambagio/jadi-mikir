...
## Completion State — Diagnostic Results

Shown immediately after the placement test finishes (or after tapping "Skip placement test"). Same flow, no separate route needed.
